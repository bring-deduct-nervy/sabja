...
export const metadata: Metadata = {
  title: 'Gallery | Luxury Haven Hotel & Spa',
  description: 'Explore stunning images of our luxury hotel, facilities, and breathtaking surroundings.',
};
    ...
    <div className="min-h-screen bg-[--cream] px-4 py-16 sm:px-6 lg:px-8">
      <div className="mx-auto max-w-4xl text-center">
        ...
        <p className="mb-8 text-lg text-gray-600">
          This page is under construction. Our gallery will be available soon.
        </p>
        <Link
          href="/"
